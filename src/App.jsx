...
function App() {
    ...
    return (
        <>
            ...
            <table>
                <ColumnLabels
                // sortAutherNameOriginal={() =>
                //     sortColumn("authorNameOriginal", !sorting.ascending)
                // }
                // sortAuthorNameTranslit={() =>
                //     sortColumn("authorNameTranslit", !sorting.ascending)
                // }
                // sortTitleOriginal={() =>
                //     sortColumn("titleOriginal", !sorting.ascending)
                // }
                // sortTitleTranslit={() =>
                //     sortColumn("titleTranslit", !sorting.ascending)
                // }
                // sortLanguage={() =>
                //     sortColumn("language", !sorting.ascending)
                // }
                // sortGenre={() => sortColumn("genre", !sorting.ascending)}
                // sortType={() => sortColumn("textType", !sorting.ascending)}
                // sortDate={() => sortColumn("date", !sorting.ascending)}
                />
                <tbody>
